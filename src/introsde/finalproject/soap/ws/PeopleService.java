 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.finalproject.introsde/", wsdlLocation = "https://lds-hidden-taiga-5842.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.soap.finalproject.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://lds-hidden-taiga-5842.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.soap.finalproject.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.soap.finalproject.introsde/", "PeopleImplPort"), People.class, features);
    }
